...
<body id="page-top" class="index" style="background-color: #e3e3e3;">
    ...
    <div class="container">
      <div class="row">
          <div class="col-md-6"> 
            ...
            <iframe scrolling="no" width="100%" height="510px" frameborder="0" src="contacto/contacto.html""></iframe>
          </div>
          <div class="col-md-6">
 ...
 ?>
  ...
  <script src="contacto/js/jqBootstrapValidation.js"></script>
  <script src="contacto/js/contact_me.js"></script>
