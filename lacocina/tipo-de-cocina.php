      ...
      <div class="col-md-6" style="text-align: right;">
        <div class="input-group">
          <span class="input-group-btn">
            <button class="botonagregarnuevo btn btn-default" type="button" style="padding: 17px;" onClick="agregarTipoCocina()"><i class="fa fa-plus-square-o" aria-hidden="true"></i> AGREGAR NUEVO</button>
          </span>
        </div>
      </div>
    </div>
   ...
   <div class="modal-dialog">
      <div class="modal-content">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h3>No se pudo eliminar el Tipo de Cocina</h3>
     </div>
         <div class="modal-body">
            <h5>Este Tipo de Cocina tiene Locales asociados</h5>
