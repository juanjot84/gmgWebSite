    ...
    <div class="container-fluid" style="padding: 1%;background: yellow;margin-top: -21px;">
        <div class="container">
            ...
            <div class="col-md-6" style="text-align: right;">
                <div class="input-group">
                  <span class="input-group-btn">
                    <button class="btn btn-default" type="button" style="padding: 17px;" onClick="agregarOcasion()"><i class="fa fa-plus-square-o" aria-hidden="true"></i> AGREGAR NUEVO</button>
                </span>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="" id="formularioAgregar" style="display:none">
              ...
              <input type="text" name="id" id="idOcasion" class="hidden">
            
              <p><div class="input-group input-group-sm">
                <span class="input-group-addon" id="sizing-addon3"><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></span>
                <input id="nombreOcasion" name="nombreOcasion" type="text" class="form-control" placeholder="Nombre de la Ocasion" aria-describedby="sizing-addon3">
              </div></p>
            
              <p><div class="input-group input-group-sm">
                <span class="input-group-addon" id="sizing-addon3"><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></span>
                <input id="descripcionOcasion" name="descripcionOcasion" type="text" class="form-control" placeholder="Descripción de la Ocasion" aria-describedby="sizing-addon3">
              </div></p>
              ...
              <!-- Table -->
              <div class="panel-heading tituloseccion">Ocasiones</div>
                  <table class="table">
