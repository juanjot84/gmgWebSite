...
$.ajax({
    ...
    success: function (data) {
      ...
      _.each(data, function(reservas){ 
        _.each(reservas, function(reserva){ 
          ...
          var registro = [idcont, estadoReserva, reserva.fechaReserva, reserva.nombreUsuarioReserva, reserva.cubiertosTotales];
          lista.push(registro);
          idcont++;
      });
    });
    ...
    var columns = ["ID", "Estado reserva", "Fecha", "Nombre", "Cantidad de personas"];
    var rows = lista;
