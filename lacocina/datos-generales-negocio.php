...
<h5 class="titulosalta">LIMITAR MESAS</h5>
               
              <label class="titulohorarioatencion">Hasta  <strong class="naranja"><span id="demo3"></span> Niños</strong> por mesa.</label>
              <span class="valorrecomendado">Valor recomendado: 1</span>
              <div class="slidecontainer">
                <p class="horasanticipacion"></p>
                <input type="range" min="0" max="48" value="0" class="slider1" id="myRange3" onchange="actualizarMargen('myRange3')">
              </div>
              
              <label class="titulohorarioatencion">Hasta <strong class="naranja"><span id="demo4"></span> Adultos</strong> por mesa.</label>
              <span class="valorrecomendado">Valor recomendado: 2</span>
              <div class="slidecontainer">
                <p class="horasanticipacion">Horas: </p>
                <input type="range" min="0" max="48" value="1" class="slider1" id="myRange4" onchange="actualizarMargen('myRange4')">
              </div>
