      ...
      <div class="container">
        <div class="row">
            ...
            <div class="col-md-4" style="text-align: right; padding: 1% 0;">
                <p style="color: #fff">Hola Pepito Lopez</p><a class="botsalir" style="color: #FFFF00" href="scripts/cerrar_sesion.php"><i class="fa fa-user" aria-hidden="true"></i> SALIR</a>
            </div>
        </div>
      </div>
    </div>
        ...
        <nav class="navbar navbar-default">
          <div class="container" style="margin-top: -1px;">
            ...
            <div class="navbar-header">
              <p class="nombrenegocioresponsive hidden-md hidden-lg">Nombre negocio</p>
