          ...
          <form action="" id="formularioAgregar">
            ...
            <p>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <input id="HdesdeLunes" name="HdesdeLunesManana" type="text" class="form-control" placeholder="Hora desde HH:MM" aria-describedby="sizing-addon3" onfocus="limpiar('HhastaLunes','HdesdeLunes')">
                </div>
                <div class="col-md-6">
                  <input id="HhastaLunes" name="HhastaLunesManana" type="text" class="form-control" placeholder="Hora hasta HH:MM" aria-describedby="sizing-addon3" onfocus="limpiar('HhastaLunes','HhastaLunes')">
                </div>
              </div>
              <div class="row">
                <span class="row">Horario de atención de tarde</span>
                <div class="col-md-6">
                  <input id="HdesdeLunes" name="HdesdeLunesTarde" type="text" class="form-control" placeholder="Hora desde HH:MM" aria-describedby="sizing-addon3" onfocus="limpiar('HhastaLunes','HdesdeLunes')">
                </div>
                <div class="col-md-6">
                  <input id="HhastaLunes" name="HhastaLunesTarde" type="text" class="form-control" placeholder="Hora hasta HH:MM" aria-describedby="sizing-addon3" onfocus="limpiar('HhastaLunes','HhastaLunes')">
                </div>
              </div>
            </p>
            <p>
